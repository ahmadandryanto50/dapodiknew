...
export const SchoolModule: React.FC<SchoolModuleProps> = ({
  ...
  return (
    <div className="space-y-6">
      {/* Header Bar */}
      <div className="sticky top-[57px] z-30 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white/95 backdrop-blur-xl border border-sky-100 p-5 rounded-2xl shadow-md transition-all">

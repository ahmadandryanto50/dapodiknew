                    ...
                    <div className="relative inline-block text-left">
                      ...
                      {openActionId === item.id && (
                        <>
                          ...
                          />
                          <div 
                            className={`absolute right-0 z-50 w-44 bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-slate-200/80 py-1.5 text-xs text-slate-700 divide-y divide-slate-100 ring-1 ring-black/5 animate-in fade-in zoom-in-95 duration-150 ${
                              idx >= Math.max(1, filteredSarpras.length - 2)
